...
DT denoiser has no upsampling (patchifies & un-patchifies at constant resolution), but the VAE decoder performs convolutional upsampling. Whereas U-Net diffusion models upsample in the denoise AND the decoder.
